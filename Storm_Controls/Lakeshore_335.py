...
# This class interfaces to the Lakeshore 335 temp controller.
...
class Lakeshore(object):
    def __init__(self, master):
        #self.master = master
        self.lakeshore_device_name='/dev/lakeshore_335'
        self.Temp_A = 999.0
        self.Temp_B = 999.0
        self.Temp_Set = 999.0
        return
    ...
    def Initialize_Serial(self):
        ...
        try:
            ...
            print "Failed to initialize Lakeshore Serial Bus. Exception of type %s and args = \n"%type(e).__name__, e.args    
            return
    ...
    def Close_Serial(self):
        ...
        try:
            ...
            print "Failed to close Lakeshore Serial Bus. Exception of type %s and args = \n"%type(e).__name__, e.args    
            return
    ...
    def Check_Communications(self):
        ...
        try:
            ...
            print "No communication to Lakeshore Temp controller. Exception of type %s and args = \n"%type(e).__name__, e.args    
            self.comm_status = False
        self.ser.close()
        return
