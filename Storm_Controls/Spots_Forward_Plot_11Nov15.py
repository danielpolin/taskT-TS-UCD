...
for i, segmentnumber in enumerate([4,5,12,13]):
    ...
    slope, intercept, r_value, p_value, std_err = stats.linregress(imaxs[i,4:16],sigmaxs[i,4:16])
    ...
    slope, intercept, r_value, p_value, std_err = stats.linregress(imaxs[i,4:16],sigmays[i,4:16])
