...
try:
    f = open('/home/ccd/cryostat/Log_Files/N2Bottle_log.dat','a')
    ...
    tkMessageBox.showinfo('N2 Cylinder Change Logged', messagelist[index]+'\nLog time: '+now.strftime("%Y-%m-%d-%H:%M:%S"))
except:
    tkMessageBox.showwarning('N2 Cylinder Log Failed', 'Something went wrong with the logging code!')
