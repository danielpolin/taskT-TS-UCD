...
#sequencerlist=["v26","v27_rt750_iso2_450","v27_rt150","v27_rt300","v27_rt450","v27_rt600","v27_rt750","v27_rt750_iso1_140","v27_rt750_iso1_210","v27_rt750_iso1_70","v27_rt750_iso2_150","v27_rt750_iso2_300"]
sequencerlist=["v27_rt450","v27_rt600","v27_rt750","v27_rt750_iso1_140","v27_rt750_iso1_210","v27_rt750_iso1_70","v27_rt750_iso2_150","v27_rt750_iso2_300"]
...
def full_sequencer_run(sleeptime):
    ...
    for sequencerfilename in sequencerlist:
        ...
        try:
            ...
            eWarning("Error in changing sequencer to "+str(sequencerfilename))
            raise Exception("Error in changing sequencer to "+str(sequencerfilename))
